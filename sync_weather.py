...
def update_logs_and_readme(all_observations):
    ...
    # 3. Generate Table for README
    table = "## 🌬️ Windy Days Tracker (Last 30 Days)\n"
    ...
    for name in history:
        ...
        for e in history[name]:
            ...
            if 8 <= dt.hour <= 20:
                ...
                if e['ws_knots'] >= 14.0: day_stats[d_str] += 1
        
        # 12 samples of 10 mins = 2 hours
...
if __name__ == "__main__":
    ...
    if current_runs:
        update_logs_and_readme(current_runs)import requests
import xml.etree.ElementTree as ET
import hashlib
import time
import os
